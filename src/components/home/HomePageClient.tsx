...
export default function HomePageClient({ dataByLocale, defaultLocale }: HomePageClientProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 bg-background min-h-[calc(100vh-12rem)] flex items-center">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 w-full -mt-16">
