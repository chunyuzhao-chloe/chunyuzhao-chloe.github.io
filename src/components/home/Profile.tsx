...
export default function Profile({ author, features, researchInterests }: ProfileProps) {
    ...
    return (
        ...
        >
            {/* Profile Image */}
            <div className="w-40 h-56 mx-auto mb-6 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
                <Image
                    src={author.avatar}
                    alt={author.name}
                    width={256}
                    height={341}
                    className="w-full h-full object-cover object-[32%_15%]"
                    priority
                />
            </div>
